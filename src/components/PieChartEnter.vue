...
export default {
  ...
  computed: {
    ...Vuex.mapGetters(["getStages", "getStagePercents"]),
    ...
    stageCounts() {
      ...
      if (filteredPercents && filteredPercents[this.index]) {
        result = [
          filteredPercents[this.index].notstarted,
          filteredPercents[this.index].scheduled,
          filteredPercents[this.index].inprogress,
          filteredPercents[this.index].impediment,
          filteredPercents[this.index].completed
        ];
      }
      return result;
    },
