...
export default function createStore(appId) {
  return new Vuex.Store({
    ...
    getters: {
      // Use mapState for accessing all store properties or define custom getters here.
    ...
    mutations: {
      /*Simple setters - use a currying function defined at bottom*/
      setActivities: set("activities"),
      setActivityPercents: set("activityPercents"),
      setBDPercents: set("bdPercents"),
      setFromRoute: set("fromRoute"),
      setLoading: set("loading"),
      setStages: set("stages"),
      setStageHover: set("stageHover"),
      setStagePercents: set("stagePercents"),
...
/*Currying function for mutations*/
